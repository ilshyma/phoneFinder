...
public final class CorezoidMessage {
    private List<RequestOperation> operations;
//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
    ...
    public static CorezoidMessage request(String apiSecret, String apiLogin, List<RequestOperation> operations) {
...
//----------------------------------------------------------------------------------------------------------------------
    ...
    public static CorezoidMessage requestGet(String apiSecret, String apiLogin,
                                             List<RequestOperationGetInfo> operations) {
        if (apiSecret == null || apiSecret.equals("")) {
            throw new IllegalArgumentException("apiSecret is null or empty");
        }
        if (apiLogin == null || apiLogin.equals("")) {
        ...
        obj.element(ops, new JSONArray());
        JSONArray jsOps = new JSONArray();
        for (RequestOperationGetInfo op : operations) {
            jsOps.add(op.toJSONObject());
        }
        obj.element(ops, jsOps);
        String content = obj.toString();
